            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    <label for="nama_lengkap" class="block text-sm font-medium text-gray-900">Nama Lengkap Beserta
                        Gelar</label>
                    <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ $biodata->nama_lengkap }}"
                ...
                <div class="grid grid-col-1 md:grid-cols-2 md:gap-6">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="nomer_induk_warga" name="nomer_induk_warga"
                            value="{{ $biodata->nomer_induk_warga }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="nomer_induk_keluarga" name="nomer_induk_keluarga"
                            value="{{ $biodata->nomer_induk_keluarga }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                ...
                <div class="grid grid-col-1 md:grid-cols-2 md:gap-6">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ $biodata->tanggal_lahir }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            required />
                    </div>
                </div>
                ...
                <div class="grid grid-col-1 md:grid-cols-2 md:gap-6">
                    ...
                    <div class="mb-5">
                        ...
                        <select id="jenis_kelamin" name="jenis_kelamin"
                            ...
                            <option value="Pria" {{ $biodata->jenis_kelamin == 'Pria' ? 'selected' : '' }}>
                                Pria</option>
                    ...
                    <div class="mb-5">
                        ...
                        <select id="status_pernikahan" name="status_pernikahan"
                            ...
                            <option value="Belum Kawin"
                                {{ $biodata->status_pernikahan == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin</option>
                            <option value="Kawin" {{ $biodata->status_pernikahan == 'Kawin' ? 'selected' : '' }}>Kawin
                            </option>
                            <option value="Duda" {{ $biodata->status_pernikahan == 'Duda' ? 'selected' : '' }}>Duda
                            </option>
                            <option value="Janda" {{ $biodata->status_pernikahan == 'Janda' ? 'selected' : '' }}>Janda
                            </option>
                        </select>
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <textarea id="alamat" name="alamat"
                        ...
                        placeholder="Alamat Lengkap" required>{{ $biodata->alamat }}</textarea>
                </div>
                ...
                <div class="grid grid-col-1 md:grid-cols-2 md:gap-6">
                    ...
                    <div class="mb-5">
                        ...
                        <select id="jenis_pekerjaan" name="jenis_pekerjaan"
                            ...
                            <option value="Pedagang" {{ $biodata->jenis_pekerjaan == 'Pedagang' ? 'selected' : '' }}>
                                Pedagang</option>
                            <option value="Wiraswasta" {{ $biodata->jenis_pekerjaan == 'Wiraswasta' ? 'selected' : '' }}>
                                Wiraswasta</option>
                            <option value="Swasta" {{ $biodata->jenis_pekerjaan == 'Swasta' ? 'selected' : '' }}>Swasta
                            </option>
                            <option value="Karyawan Perusahaan"
                                {{ $biodata->jenis_pekerjaan == 'Karyawan Perusahaan' ? 'selected' : '' }}>
                                Karyawan Perusahaan</option>
                            <option value="ASN" {{ $biodata->jenis_pekerjaan == 'ASN' ? 'selected' : '' }}>ASN</option>
                            <option value="TNI" {{ $biodata->jenis_pekerjaan == 'TNI' ? 'selected' : '' }}>TNI</option>
                            <option value="POLRI" {{ $biodata->jenis_pekerjaan == 'POLRI' ? 'selected' : '' }}>POLRI
                            </option>
                            <option value="Lainnya" {{ $biodata->jenis_pekerjaan == 'Lainnya' ? 'selected' : '' }}>Lainnya
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="lembaga_instansi" name="lembaga_instansi"
                            value="{{ $biodata->lembaga_instansi }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                ...
                <div class="mb-5">
                    ...
                    <textarea id="alamat_lembaga_instansi" name="alamat_lembaga_instansi"
                        ...
                        placeholder="Alamat Lembaga/Instansi" required>{{ $biodata->alamat_lembaga_instansi }}</textarea>
                </div>
