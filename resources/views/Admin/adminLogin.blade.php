...
<body class="bg-white h-screen w-screen p-4 grid grid-cols-1 lg:grid-cols-2">
    <div class="w-full h-full hidden lg:block"
        style="background-image: url('{{ asset('asset/admin_bg.jpg') }}'); background-size: cover; background-position: center;">
    </div>

    <div class="w-full h-full flex flex-col justify-center items-center">
        <h1 class="text-xl md:text-2xl font-medium mb-2 text-center">Hi! Selamat Datang</h1>
        <h1 class="text-xl md:text-2xl font-medium mb-10 text-center">Mohon login terlebih dahulu sebagai admin</h1>
