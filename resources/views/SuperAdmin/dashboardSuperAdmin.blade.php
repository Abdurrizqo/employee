...
@section('content')
    ...
    <div class="border rounded-lg p-3 w-full bg-white">
        <h1 class="text-gray-800 md:text-xl font-semibold mb-4">Export Data Warga</h1>
        <form class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <select id="rantingExport"
        ...
        <p id="pesanExport" class="text-gray-600 text-xs md:text-sm mt-5 text-center md:text-left hidden"></p>
    </div>

    <div class="border rounded-lg p-3 w-full bg-white" id="containerAdd">
        <form id="addForm" class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
                ...
                <span id="namaAnggotaError" class="text-red-500 text-xs hidden">Nama anggota minimal 4 karakter</span>
            </div>
            ...
            </div><span id="passwordError" class="text-red-500 text-xs hidden">Password minimal 6 karakter dan maksimal 24
                karakter</span>
    ...
    <div class="border rounded-lg p-3 w-full bg-white hidden" id="containerEdit">
        <form id="editForm" class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <input type="text" id="nama_anggota_edit"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="nama anggota" required />
                <span id="namaAnggotaErrorEdit" class="text-red-500 text-xs hidden">Nama anggota minimal 4 karakter</span>
            </div>
            ...
            <div>
                ...
                <input type="password" id="passwordEdit"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="Password" required />
            </div><span id="passwordErrorEdit" class="text-red-500 text-xs hidden">Password minimal 6 karakter dan
                maksimal
                24
                karakter</span>
    ...
    @vite(['resources/js/user/addUser.js', 'resources/js/user/getUser.js', 'resources/js/user/exportData.js'])
@endsection
